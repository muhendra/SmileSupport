...
namespace DXMNCGUI_SMILE_SUPPORT_SYSTEM.Controllers
{
    ...
    public class SqlLocalDBSetting : IDisposable
    {
        ...
        private BeforeOpenLocalConnectionEventHandler BeforeOpenLocalConnectionEvent;
        ...
        public string PrivateDataPath
        {
            get
            {
                ...
                string path = Application.ApplicationDataPath + (object)Path.DirectorySeparatorChar + ((object)stringBuilder).ToString();
        ...
        public event BeforeOpenLocalConnectionEventHandler myBeforeOpenLocalConnectionEvent
        {
            ...
            add
            {
                this.BeforeOpenLocalConnectionEvent = this.BeforeOpenLocalConnectionEvent + value;
            }
            [MethodImpl(MethodImplOptions.Synchronized)]
            remove
            {
        ...
        public SqlLocalDBSetting(DBServerType serverType, string connectionString, int commandTimeout)
        {
        ...
        public SqlLocalDBSetting(DBServerType serverType, string serverName, string userId, string password, string dbName)
            : this(serverType, serverName, userId, password, dbName, true)
        {
        }
        public SqlLocalDBSetting(DBServerType serverType, string serverName, string userId, string password, string dbName, bool usePool)
        {
            if (serverName == null)
        ...
        public SqlLocalDBSetting(DBServerType serverType, string serverName, string dbName)
            : this(serverType, serverName, dbName, true)
        {
        }
        public SqlLocalDBSetting(DBServerType serverType, string serverName, string dbName, bool usePool)
        {
            if (serverName == null)
                throw new ArgumentNullException("serverName");
            else if (dbName == null)
        ...
        private void OpenConnection()
        {
            try
            {
                if (this.BeforeOpenLocalConnectionEvent != null)
                    this.BeforeOpenLocalConnectionEvent(this);
            ...
            catch (Exception ex1)
            {
                ...
                if (ex2 != null)
                    BCE.Data.DataError.HandleSqlException(ex2);
                else
                    throw;
            }
        }
        ...
        public SqlLocalDBSetting Copy()
        {
            return new SqlLocalDBSetting(this.ServerType, this.ConnectionString, this.CommandTimeOut)
            {
                myServerName = this.ServerName,
                myDBName = this.DBName,
                BeforeOpenLocalConnectionEvent = this.BeforeOpenLocalConnectionEvent
            };
        }
        ...
        public SqlLocalDBSetting StartTransaction()
        {
