<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="PolisAsuransiFAMaint.aspx.cs" Inherits="DXMNCGUI_SMILE_SUPPORT_SYSTEM.Transactions.Insurance.PolisAsuransiFAMaint" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dx:ASPxFormLayout runat="server" ID="FormLayout1" ClientInstanceName="FormLayout1" Font-Names="Calibri">
        ...
        <Items>
            <dx:LayoutGroup ShowCaption="True" GroupBoxDecoration="HeadingLine" Caption="Polis Asuransi Fixed Asset Listing" ColCount="5">
                <GroupBoxStyle>
                            ...
                            <dx:LayoutItemNestedControlContainer>
                                <dx:ASPxGridView
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn Name="colDocNo" Caption="Asset No." FieldName="DocNo" ReadOnly="True" ShowInCustomizationForm="true" Visible="true" VisibleIndex="0">
                                            <HeaderStyle BackColor="WhiteSmoke" Font-Bold="true"/>
                                        </dx:GridViewDataTextColumn>
                                        ...
                                        <dx:GridViewDataTextColumn Name="colAssetDesc" Caption="Asset Desc" FieldName="AssetDesc" ReadOnly="True" ShowInCustomizationForm="true" Visible="true" VisibleIndex="2">
                                            <HeaderStyle BackColor="WhiteSmoke" Font-Bold="true"/>
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Name="colNoPolisi" Caption="No. Polisi" FieldName="NoPolisi" ReadOnly="True" ShowInCustomizationForm="true" Visible="true" VisibleIndex="3">
                                            <HeaderStyle BackColor="WhiteSmoke" Font-Bold="true"/>
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataMemoColumn Name="colNoRangka" Caption="No. Rangka" FieldName="NoRangka" ReadOnly="true" ShowInCustomizationForm="true" VisibleIndex="4">
                                            <HeaderStyle BackColor="WhiteSmoke" Font-Bold="true"/>
                                        </dx:GridViewDataMemoColumn>                 
                                        <dx:GridViewDataDateColumn Name="colNoMesin" Caption="No. Mesin" FieldName="NoMesin" ReadOnly="true" PropertiesDateEdit-DisplayFormatString="dd/MM/yyyy" ShowInCustomizationForm="true" VisibleIndex="5">
                                            <HeaderStyle BackColor="WhiteSmoke" Font-Bold="true"/>
                                        </dx:GridViewDataDateColumn>
                                    </Columns>
