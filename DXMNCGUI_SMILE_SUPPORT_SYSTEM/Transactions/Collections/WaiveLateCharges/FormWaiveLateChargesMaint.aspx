                            ...
                            <dx:LayoutItemNestedControlContainer>
                                <dx:ASPxGridView
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn Name="colRefNo" Caption="Contract No." FieldName="RefNo" ReadOnly="True" ShowInCustomizationForm="true" Visible="true" VisibleIndex="2" Width="15%">
                                            <HeaderStyle BackColor="WhiteSmoke" Font-Bold="true"/>
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Name="colLateChargesAmount" Caption="Late Charges Amount" FieldName="LateChargesAmount" ReadOnly="True" ShowInCustomizationForm="true" Visible="false" VisibleIndex="3" Width="15%">
                                            <HeaderStyle BackColor="WhiteSmoke" Font-Bold="true"/>
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataSpinEditColumn Name="colWaiveAmount" Caption="Waive Amount" FieldName="WaiveAmount" ReadOnly="True" ShowInCustomizationForm="true" PropertiesSpinEdit-DisplayFormatString="#,0.00" VisibleIndex="4" Width="15%">
                                            <HeaderStyle BackColor="WhiteSmoke" Font-Bold="true"/>
                                        </dx:GridViewDataSpinEditColumn>
                                        <dx:GridViewDataMemoColumn Name="colRemark1" Caption="Remark 1" FieldName="Remark1" ReadOnly="true" ShowInCustomizationForm="true" VisibleIndex="5">
                                            <HeaderStyle BackColor="WhiteSmoke" Font-Bold="true"/>
                                        </dx:GridViewDataMemoColumn>
                                        <dx:GridViewDataMemoColumn Name="colRemark2" Caption="Remark 2" FieldName="Remark2" ReadOnly="true" Visible="false" ShowInCustomizationForm="true" VisibleIndex="6">
                                            <HeaderStyle BackColor="WhiteSmoke" Font-Bold="true"/>
                                        </dx:GridViewDataMemoColumn>
                                        <dx:GridViewDataMemoColumn Name="colRemark3" Caption="Remark 3" FieldName="Remark3" ReadOnly="true" ShowInCustomizationForm="true" VisibleIndex="7" Visible="false">
                                            <HeaderStyle BackColor="WhiteSmoke" Font-Bold="true"/>
                                        </dx:GridViewDataMemoColumn>
                                        <dx:GridViewDataMemoColumn Name="colRemark4" Caption="Remark 4" FieldName="Remark4" ReadOnly="true" ShowInCustomizationForm="true" VisibleIndex="8" Visible="false">
                                            <HeaderStyle BackColor="WhiteSmoke" Font-Bold="true"/>
                                        </dx:GridViewDataMemoColumn>
                                        <dx:GridViewDataComboBoxColumn Name="colCancelled" Caption="Cancel" FieldName="Cancelled" ReadOnly="true" ShowInCustomizationForm="false" VisibleIndex="9">
                                            <HeaderStyle BackColor="WhiteSmoke" Font-Bold="true"/>
                                        </dx:GridViewDataComboBoxColumn>
                                        <dx:GridViewDataTextColumn Name="colStatus" Caption="Status" FieldName="Status" ReadOnly="true" ShowInCustomizationForm="true" VisibleIndex="10">
                                            <HeaderStyle BackColor="WhiteSmoke" Font-Bold="true"/>
                                        </dx:GridViewDataTextColumn>
                                    </Columns>
